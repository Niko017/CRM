...
function insertRemoteImage() {
  ...
  if (url !== null || url !== "") this.quill.insertEmbed(range.index, 'image', url, Quill.sources.USER_PASTE);
}
      ...
      <div id="toolbar">
        ...
        <span className="ql-formats">
          ...
          <select className="ql-size" defaultValue="large">
            <option value="large">Header 1</option>
            <option value="medium">Header 2</option>
            <option value="extra-small">Header 3</option>
            <option value="small">Header 4</option>
          </select>
          <select className="ql-header" defaultValue="3">
            <option value="1">Titulo</option>
            <option value="2">Subtitulo</option>
            <option value="3">Párrafo</option>
          </select>
        </span>
        <span className="ql-formats">
